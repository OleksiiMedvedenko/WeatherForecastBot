...
{
    static class DescriptionOnEng
    {
        /// <summary>
        /// Описание взято из официального сайта - эти переменные мы получаем из сайта https://openweathermap.org/weather-conditions
        /// </summary>
        public static List<string> EngDescription = new List<string>()
        {
            ...
            "shower rain","heavy intensity shower rain","ragged shower rain","light snow","Snow","Heavy snow","Sleet","Light shower sleet",
            "Shower sleet","Light rain and snow","Rain and snow","Light shower snow","Shower snow","Heavy shower snow","mist","Smoke",
            "Haze","sand/ dust whirls","fog","sand","dust","volcanic ash","squalls","tornado","clear sky","few clouds",
